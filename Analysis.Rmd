...
```{r}
data_filtered <- data %>%
  select(-Sample.Size.Female.adult.weight, -Sample.size.Clutch.Size., -Sample.size.Mean.F.SVL.adults, SD.Female.adult.weight..g., -SD.F.SVL.adults..mm., -Average.Female.adult.weight..g., -RCM)
```
