...
# Convert factors to characters and replace "" with NA
data <- data %>%
...
```{r}
# Here I select only the variables to use for the CA and CCA
data_CCA <- data %>%
...
# Make a frequency containing all 4 categorical variables to be used
